...
define("@scom/scom-covalent/global/interfaces.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("@scom/scom-covalent/global/utils.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-covalent/global/index.ts", ["require", "exports", "@scom/scom-covalent/global/interfaces.ts", "@scom/scom-covalent/global/utils.ts"], function (require, exports, interfaces_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-covalent/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.covalentStyle = exports.containerStyle = void 0;
    ...
    exports.covalentStyle = components_1.Styles.style({
        display: 'block',
        $nest: {
            '&.covalent-dark--theme': {
                background: '#100c2a',
...
define("@scom/scom-covalent/data.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-covalent", ["require", "exports", "@ijstech/components", "@scom/scom-covalent/global/index.ts", "@scom/scom-covalent/index.css.ts", "@scom/scom-configurator-settings"], function (require, exports, components_2, index_1, index_css_1, scom_configurator_settings_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Theme = components_2.Styles.Theme.ThemeVars;
    let ScomCovalent = class ScomCovalent extends components_2.Module {
        ...
        async renderPlaceholder() {
            this.vStackCovalent.clearInnerHTML();
            this.vStackCovalent.appendChild(this.$render("i-vstack", { gap: 20, horizontalAlignment: "center", verticalAlignment: "center", height: 100, maxHeight: "100%", onClick: this.showConfig, class: "pointer" },
                this.$render("i-label", { caption: "Covalent Block", font: { size: '20px' } }),
                this.$render("i-icon", { name: "plus", fill: Theme.colors.primary.contrastText, width: 36, height: 36 })));
        }
        async init() {
            this.isReadyCallbackQueued = true;
            super.init();
            this.classList.add(index_css_1.covalentStyle);
            this.width = this.tag.width || 700;
            this.maxWidth = '100%';
            ...
            const endpoint = this.getAttribute('endpoint', true);
            const options = this.getAttribute('options', true);
            this.setData({ componentId, endpoint, options });
        ...
        render() {
            return (this.$render("i-panel", { display: "flex", height: "100%", width: "100%" },
                this.$render("i-vstack", { id: "vStackCovalent", gap: 20, height: "100%", background: { color: Theme.background.main }, padding: { top: 10, bottom: 10, left: 10, right: 10 }, class: index_css_1.containerStyle }),
                this.$render("i-modal", { id: "mdConfig", width: 1000 },
                    this.$render("i-panel", { id: "pnlConfig" }))));
        }
    };
    ScomCovalent = __decorate([
        components_2.customModule,
        (0, components_2.customElements)('i-scom-covalent')
    ], ScomCovalent);
    exports.default = ScomCovalent;
});
